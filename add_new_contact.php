    ...
    if ($_POST['email'] == '' && $_POST['mobile'] == '') {
        ...
        if ($_POST['email'] != '') {
            ...
            if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                ...
                $exist = "select * from contact_details where email='$email' AND user_id='$id' ";
                ...
                if (($result->num_rows > 0)) {
                    ...
                    if (($result->num_rows > 0)) {
                        ...
                        $sql = "insert into contact_details  (user_id,name, email, mobile, work,home,city,group_name,picture,dob,bio) values($id,'$name','$email','$mobile','$work','$home','$city','$group_name','$picture','$dob','$bio') ";
                ...
                <div class="container">
                    <div class="text-center">
                        <h1 class="h3 text-gray-800 mb-4"
                            style="border:solid;border-width:1px;border-color:blue; background-color:white; "> Add a
                            New Contact!</h1>
                    </div>
                    <form class="user" id="add_contact" method="post" action="" enctype="multipart/form-data">
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input class="form-control form-control-user" id="Email" placeholder="Email Address"
                            ...
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user name" id="Name"
                                    placeholder="Enter Name" name="name" required style="float:right;">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select id="group_Name" class=" form-control-user form-control "
                                    style="padding:10px; height:50px;" name="group_name">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <select class="form-control form-control-user" id="City" name="city"
                            ...
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="date" class="form-control form-control-user" id="dob" min="1997-01-01"
                                    max="2030-12-31" name="dob">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
